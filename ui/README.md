...
This folder contains the Theia user interface, a ReactJS-based application. 

## Installation / Development

Usually, the UI will be run via the docker setup included in theia. If you
...
at an Theia 2 instance with CORS enabled. To do this, you can create a `.env`
